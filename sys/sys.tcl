...
set_location_assignment PIN_F8 -to SDRAM_A[1]
set_location_assignment PIN_E7 -to SDRAM_A[2]
set_location_assignment PIN_AA26 -to SDRAM_A[3]
set_location_assignment PIN_J7 -to SDRAM_A[4]
set_location_assignment PIN_C4 -to SDRAM_A[5]
set_location_assignment PIN_K8 -to SDRAM_A[6]
set_location_assignment PIN_D5 -to SDRAM_A[7]
set_location_assignment PIN_K7 -to SDRAM_A[8]
set_location_assignment PIN_C5 -to SDRAM_A[9]
set_location_assignment PIN_F9 -to SDRAM_A[10]
set_location_assignment PIN_J9 -to SDRAM_A[11]
set_location_assignment PIN_D6 -to SDRAM_A[12]
set_location_assignment PIN_G8 -to SDRAM_BA[0]
set_location_assignment PIN_C3 -to SDRAM_BA[1]
set_location_assignment PIN_AD29 -to SDRAM_DQ[0]
set_location_assignment PIN_J14 -to SDRAM_DQ[1]
set_location_assignment PIN_C10 -to SDRAM_DQ[2]
set_location_assignment PIN_H13 -to SDRAM_DQ[3]
set_location_assignment PIN_C9 -to SDRAM_DQ[4]
set_location_assignment PIN_H12 -to SDRAM_DQ[5]
set_location_assignment PIN_A9 -to SDRAM_DQ[6]
set_location_assignment PIN_G12 -to SDRAM_DQ[7]
set_location_assignment PIN_F10 -to SDRAM_DQ[8]
set_location_assignment PIN_F6 -to SDRAM_DQ[9]
set_location_assignment PIN_G10 -to SDRAM_DQ[10]
set_location_assignment PIN_G7 -to SDRAM_DQ[11]
set_location_assignment PIN_J12 -to SDRAM_DQ[12]
set_location_assignment PIN_D7 -to SDRAM_DQ[13]
set_location_assignment PIN_G11 -to SDRAM_DQ[14]
set_location_assignment PIN_A8 -to SDRAM_DQ[15]
set_location_assignment PIN_J10 -to SDRAM_CLK
set_location_assignment PIN_E3 -to SDRAM_nWE
set_location_assignment PIN_E4 -to SDRAM_nCAS
set_location_assignment PIN_D4 -to SDRAM_nCS
set_location_assignment PIN_H8 -to SDRAM_nRAS
